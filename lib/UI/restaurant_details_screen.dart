...
class RestaurantDetailsScreen extends StatelessWidget {
  ...
  // 1 The widget uses the favorites stream to determine if this restaurant is 
  // favorited and then renders the appropriate widget.
    ...
    return StreamBuilder<List<Restaurant>>(
      ...
      builder: (context, snapshot) {
        ...
        return FlatButton.icon(
          // 2 The toggleRestaurant function in FavoriteBloc is written so that 
          // the UI doesn’t need to know the state of the restaurant. It just 
          // adds it if it’s not in the list or removes it if it is.
